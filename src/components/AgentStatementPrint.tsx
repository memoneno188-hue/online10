...
export const AgentStatementPrint: React.FC<AgentStatementProps> = ({ data, onClose }) => {
    ...
    const handlePrint = () => {
        ...
        const printContent = document.getElementById('statement-print-content');
        ...
        <>
            <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4" onClick={onClose}>
                <div className="bg-[#eef2f5] rounded-lg max-w-[210mm] max-h-[95vh] overflow-auto" onClick={(e) => e.stopPropagation()}>
                    ...
                    {/* Statement Content */}
                    <div className="p-5" dir="rtl" id="statement-print-content">
                        <div className="w-full bg-white p-4 rounded-lg shadow-sm print:shadow-none print:p-2">

                            {/* Header */}
                            <header className="flex justify-between items-start border-b-2 border-blue-900 pb-5 mb-6">
                                <div className="flex flex-col">
                                    <h1 className="text-[22px] font-bold text-blue-900 mb-1">{data.companyName}</h1>
                                    <h2 className="text-lg font-medium text-gray-500 mb-2">{data.companyNameEn}</h2>
                                    <div className="flex gap-5 text-[13px] text-gray-600">
                            ...
                            {/* Title Bar */}
                            <div className="flex justify-between items-center bg-blue-50 border border-blue-100 rounded-md p-3 mb-6">
                            ...
                            {/* Info Grid */}
                            <div className="grid grid-cols-2 gap-5 mb-6 print:grid-cols-2">
                                {/* Box 1: Agent Info */}
                                ...
                                <table className="w-full text-[13px] border-collapse" style={{ tableLayout: 'fixed' }}>
                                    ...
                                    <thead>
                                        <tr className="bg-blue-900 text-white">
                                            <th className="p-2 text-right font-medium whitespace-nowrap">التاريخ</th>
                                            <th className="p-2 text-right font-medium">البيــــــــــــــــــــــان</th>
                                            <th className="p-2 text-center font-medium whitespace-nowrap">عدد الشاحنات</th>
                                            <th className="p-2 text-left font-bold">دائن</th>
                                            <th className="p-2 text-left font-bold">مدين</th>
                                            <th className="p-2 text-left font-bold">الرصيد</th>
                                        </tr>
                                    </thead>
                                    <tbody className="text-gray-800">
                                        {data.transactions.map((row, index) => (
                                            <tr key={index} className="border-b border-gray-200 even:bg-slate-50 hover:bg-gray-50">
                                                <td className="p-1.5 text-gray-600">{row.date}</td>
                                                <td className="p-1.5 text-gray-800 text-[12px]">{row.description}</td>
                                                <td className="p-1.5 text-gray-800 text-center">{row.count}</td>

                                                {/* دائن */}
                                                <td className="p-1.5 text-left font-mono font-bold text-gray-800">
                                                ...
                                                {/* الرصيد */}
                                                <td className="p-1.5 text-left font-mono font-extrabold text-gray-800 bg-slate-100">
                            ...
                            {/* Summary Boxes */}
                            <div className="grid grid-cols-3 gap-4 mb-6 mt-5 summary-section">
                            ...
                            {/* Footer / Signatures */}
                            <footer className="flex justify-between items-end pt-5 border-t border-gray-200 mt-auto signatures">
