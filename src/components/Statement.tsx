                ...
                <div className="print-container w-full max-w-[210mm] min-h-[297mm] bg-white p-8 md:p-12 shadow-lg rounded-lg relative print:shadow-none print:w-full print:max-w-full print:m-0">
                    ...
                    <header className="flex justify-between items-start border-b-2 border-blue-900 pb-6 mb-8">
                        <div className="flex flex-col">
                            <h1 className="text-2xl font-bold text-blue-900 mb-1">مؤسسة ساحل الشمال للتخليص الجمركي</h1>
                            <h2 className="text-sm font-medium text-gray-500 mb-3">Sahil Al-shamal For Customs Clearance</h2>
                            <div className="flex gap-4 text-xs text-gray-600">
                                <span><strong className="text-blue-900">الرقم الضريبي:</strong> 310430599900003</span>
                                <span className="text-gray-300">|</span>
                                <span><strong className="text-blue-900">ترخيص رقم:</strong> 4003</span>
                            </div>
                        </div>
