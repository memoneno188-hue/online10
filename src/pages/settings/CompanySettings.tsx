        ...
        <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">شعار الشركة</h3>
                    ...
                    <div className="flex items-start gap-6">
                        ...
                        <div className="flex-shrink-0">
                            {logoPreview || currentLogo ? (
                                <img
                                    ...
                                    alt="Company Logo"
                                    className="w-32 h-32 object-contain border-2 border-gray-200 dark:border-gray-600 rounded-lg"
                                />
                            ) : (
                        ...
                        <div className="flex-1">
                            <label className="block">
                                <div className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 cursor-pointer transition-colors w-fit">
                ...
                {/* Company Information */}
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">معلومات الشركة</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                اسم الشركة (English) <span className="text-red-500">*</span>
                            </label>
                            <input
                                {...register('nameEn')}
                                type="text"
                        ...
                        <div>
                            ...
                            />
                            {errors.licenseNo && (
                                <p className="text-red-500 text-sm mt-1">{errors.licenseNo.message}</p>
                            )}
                        </div>
