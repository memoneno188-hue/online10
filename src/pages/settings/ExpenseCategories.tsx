...
export default function ExpenseCategories() {
    ...
    const handleAddCategory = async (e: React.FormEvent) => {
        ...
        try {
            ...
            alert(error.response?.data?.message || 'حدث خطأ أثناء إضافة التصنيف');
        } finally {
            setSubmitting(false);
        }
    };
    ...
    const handleDeleteCategory = async (id: string, name: string) => {
        ...
        try {
            ...
            alert(error.response?.data?.message || 'حدث خطأ أثناء حذف التصنيف');
        }
    };
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                        إدارة تصنيفات المصروفات المستخدمة في سندات الصرف
                    </p>
                </div>
                <button
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <p className="text-sm text-blue-900 dark:text-blue-100">
                    <strong>ملاحظة:</strong> التصنيفات المستخدمة في سندات الصرف تظهر في قائمة الدخل تحت قسم المصروفات.
                </p>
            </div>
        </div>
    );
